GO_BIN_FILES=cmd/groupsio/groupsio.go 
#for race GO_ENV=GOOS=linux CGO_ENABLED=1
GO_ENV=GO_ENV=GOOS=linux CGO_ENABLED=1
...
BINARIES=groupsio
all: check ${BINARIES}
groupsio: ${GO_BIN_FILES}
	 ${GO_ENV} ${GO_BUILD} -o groupsio ${GO_BIN_FILES}
fmt: ${GO_BIN_FILES}
	${GO_FMT} ${GO_BIN_FILES}
lint: ${GO_BIN_FILES}
